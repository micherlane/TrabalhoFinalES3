...
class PersonUIAddController {
  final DatabaseService databaseService;

  PersonUIAddController(this.databaseService);

  void addPerson(String name, String password) {
    this.databaseService.createPerson(name, password);
  }
}
  // Princípio SRP
